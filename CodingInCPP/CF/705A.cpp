...
//    //senten.push_back("I hate it ");
//    for (int i = 1; i <= n; i++) {
//        if (i  % 2 == 0) {
//            if(i!=n) senten.push_back("I love that ");
//            else senten.push_back("I love it ");
//        }
//        else {
//            if(i!=n) senten.push_back("I hate that ");
//            else senten.push_back("I hate it ");
//        }
//    }
//
//    for (auto a: senten)
