...
//    set <int> bothAB;
//    for (int i = 1; i <= C; i++) {
//        multiA.push_back(A*i);
//        multiB.push_back(B*i);
//    }
//
//    for (int i = 0; i < C; i++) {
//        bothAB.insert(multiA[i]);
//        bothAB.insert(multiB[i]);
//    }
//
//    for (auto a: bothAB) BothAB.push_back(a);
//    cout << BothAB[C - 1] << " " << LCM_GCD(1,A,B) << " " << 0 << endl;
//    
//
//
//
